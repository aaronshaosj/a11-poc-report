...
export const mockBatches: OrderBatch[] = [
  ...
  // Extreme batches for edge case testing
  { id: 'b6', name: '华东大批次', orderCount: 320, stopCount: 258, totalWeight: 152000, totalVolume: 492.50, date: '2026-03-01' },
  { id: 'b7', name: '紧急小批', orderCount: 38, stopCount: 25, totalWeight: 18200, totalVolume: 59.10, date: '2026-03-02' },
];
